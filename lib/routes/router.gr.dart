...
import 'package:bestro/pages/home/home.dart' as _i6;
import 'package:bestro/pages/login/login.dart' as _i3;
import 'package:bestro/pages/otp/otp.dart' as _i4;
import 'package:bestro/pages/profile/profile.dart' as _i8;
import 'package:bestro/pages/services/serviceDetail.dart' as _i5;
import 'package:bestro/pages/services/services.dart' as _i7;
import 'package:bestro/pages/splash/splash.dart' as _i1;
import 'package:flutter/material.dart' as _i10;

class BestRoRouter extends _i9.RootStackRouter {
  BestRoRouter([_i10.GlobalKey<_i10.NavigatorState>? navigatorKey])
      : super(navigatorKey);
  ...
  final Map<String, _i9.PageFactory> pagesMap = {
    ...
    ServicesRouter.name: (routeData) {
      return _i9.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i7.Services());
    },
  ...
  List<_i9.RouteConfig> get routes => [
        _i9.RouteConfig(Splash.name, path: '/Splash'),
        _i9.RouteConfig(BottomNavHome.name,
            path: '/bottom-nav-home',
            children: [
              _i9.RouteConfig(HomeRouter.name,
                  path: 'home-page', parent: BottomNavHome.name),
              _i9.RouteConfig(ServicesRouter.name,
        ...
        _i9.RouteConfig(Otp.name, path: '/Otp'),
        _i9.RouteConfig(ServiceDetails.name, path: '/')
      ];
}
...
/// generated route for
/// [_i2.BottomNavHome]
class BottomNavHome extends _i9.PageRouteInfo<void> {
  const BottomNavHome({List<_i9.PageRouteInfo>? children})
...
/// generated route for
/// [_i4.Otp]
class Otp extends _i9.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.ServiceDetails]
class ServiceDetails extends _i9.PageRouteInfo<void> {
  const ServiceDetails() : super(ServiceDetails.name, path: '/');
...
/// generated route for
/// [_i7.Services]
class ServicesRouter extends _i9.PageRouteInfo<void> {
